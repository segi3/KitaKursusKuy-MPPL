...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Buat Kursus</h1>
</div>
<div class="container">
    <form>
        <div class="row">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label for="judulInput">Judul Kursus</label>
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                <label for="descInput">Deskripsi Kursus</label>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label for="fileRekaman">Berkas KTP</label>
