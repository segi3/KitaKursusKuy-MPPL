...
<div class="container pb-5" style="margin-top: 100px;">
    <div class="row kursus-head">
        <div class="col-lg-4">
            <img class="card-img-top" src="{{ asset('main_resources') }}/kursus/thumbnail/art.png" alt="">
        </div>
        <div class="col-lg-6 parent-div">
            <div class="row child-div">
                <div class="col-12">
                    <h3 id="nama-kursus">Skill Dasar Dalam Menggambar</h3>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-12 mb-5">
                        <div class="card border-0">
                            <div class="card-body">
                                ...
                                <div class="div-subject">
                                    <span class="subject">Lingkaran dan Oval</span>
                                </div>
                                <div class="div-subject">
                                    <span class="subject">Garis Lurus</span>
                                </div>
                                <div class="div-subject">
                                    <span class="subject">Jalur Kurva</span>
                                </div>
                                <div class="div-subject">
                                    <span class="subject">Penerapan</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card border-0">
                    <div class="card-body">
                        <h3 class="kursus-body-header">
                            Ulasan untuk Skill Dasar Dalam Menggambar
                        </h3>
                        <div class="row mt-5">
