...
<div class="container pb-5" style="margin-top: 100px;">
    <div class="row kursus-head">
        <div class="col-lg-4">
            <img class="card-img-top" src="{{ asset('main_resources') }}/kursus/mentor/1.jpg" alt="" id="thumbPrivat">
        </div>
        <div class="col-lg-6 parent-div">
            <div class="row child-div">
                <div class="col-12">
                    <h3 id="nama-kursus">Bahasa Jerman</h3>
                    <h3 id="nama-kursus" style="color: #249EA0 !important;">Eja Suryono</h3>
                </div>
                <div class="col-12">
                        ...
                        <div class="card border-0">
                            <div class="card-body">
                                ...
                                <div class="div-subject">
                                    <span class="subject">Bahasa Jerman</span>
                                </div>
                                <div class="div-subject">
                                    <span class="subject">Kosakata - Bahasa Jerman</span>
                                </div>
                                <div class="div-subject">
                                    <span class="subject">Pemahaman Lisan - Bahasa Jerman</span>
                                </div>
