...
<div class="container pb-5">
    <div class="row kursus-head">
        <div class="col-lg-4">
            <img class="card-img-top" src="{{ asset('main_resources') }}/kursus/mentor/5.jpg" alt="" id="thumbPrivat">
        </div>
        <div class="col-lg-6 parent-div">
            <div class="row child-div">
                <div class="col-12">
                    <h3 id="nama-kursus">Ilmu Pengetahuan Alam</h3>
                    <h3 id="nama-kursus" style="color: #249EA0 !important;">Irfan Maulana</h3>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-12 mb-5">
                        <div class="card border-0">
                            <div class="card-body">
                                ...
                                <div class="div-subject">
                                    <span class="subject">Kimia</span>
                                </div>
                                <div class="div-subject">
                                    <span class="subject">Matematika</span>
                                </div>
                                <div class="div-subject">
                                    <span class="subject">Matematika Lanjutan</span>
                                </div>
                ...
                <div class="card border-0">
                    <div class="card-body">
                        <h3 class="kursus-body-header">
                            Ulasan untuk Ilmu Pengetahuan Alam
                        </h3>
                        <div class="row mt-5">
