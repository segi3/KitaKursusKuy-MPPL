...
<div class="container pb-5">
    <div class="row kursus-head">
        <div class="col-lg-4">
            <img class="card-img-top" src="{{ asset('main_resources') }}/kursus/thumbnail/gitar.jpg" alt="">
        </div>
        <div class="col-lg-6 parent-div">
            <div class="row child-div">
                <div class="col-12">
                    <h3 id="nama-kursus">Belajar Gitar dari 0</h3>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-12 mb-5">
                        <div class="card border-0">
                            <div class="card-body">
                                ...
                                <div class="div-subject">
                                    <span class="subject">Gitar Akustik</span>
                                </div>
                                <div class="div-subject">
                                    <span class="subject">Gitar Elektrik</span>
                                </div>
                                <div class="div-subject">
                                    <span class="subject">Gitar Klasik</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card border-0">
                    <div class="card-body">
                        <h3 class="kursus-body-header">
                            Ulasan untuk Belajar Gitar dari 0
                        </h3>
                        <div class="row mt-5">
