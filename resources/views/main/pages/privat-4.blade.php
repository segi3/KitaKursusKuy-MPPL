    ...
    <div class="row kursus-head">
        ...
        <div class="col-lg-6 parent-div">
            <div class="row child-div">
                <div class="col-12">
                    <h3 id="nama-kursus">Akting Seni Peran</h3>
                    <h3 id="nama-kursus" style="color: #249EA0 !important;">Winda Prastuti</h3>
                </div>
            </div>
        </div>
                        ...
                        <div class="card border-0">
                            <div class="card-body">
                                ...
                                <div class="div-subject">
                                    <span class="subject">Akting</span>
                                </div>
                                <div class="div-subject">
                                    <span class="subject">Improvisasi dalam Teater</span>
                                </div>
                                <div class="div-subject">
                                    <span class="subject">Scenografi</span>
                                </div>
                                <div class="div-subject">
                                    <span class="subject">Pertunjukan Boneka</span>
                                </div>
                ...
                <div class="card border-0">
                    <div class="card-body">
                        <h3 class="kursus-body-header">
                            Ulasan untuk Akting Seni Peran
                        </h3>
                        <div class="row mt-5">
